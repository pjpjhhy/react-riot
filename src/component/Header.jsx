    ...
    <div className='w-full flex justify-center bg-[#151515]'>
        <div className='w-full py-1 max-w-[1700px] h-full flex justify-center items-center'>
          ...
          <div className='w-full flex justify-center '>
            ...
            src="https://www.leagueoflegends.com/static/logo-1200-04b3cefafba917c9c571f9244fd28a1e.png" alt="" /></Link>
          </div>
          {/* 검색창 */}
          <div className='w-full space-x-2 flex justify-end items-center text-white'>
            <div className='w-11 h-11 text-3xl bg-[#2B2A29] rounded-full flex justify-center items-center'>
              <CiSearch />
            </div>
            <div className='text-2xl'>
              ...
              <input 
              className='w-[150px] rounded-xl bg-[#2b2a29] font-semibold pl-3 p-1 outline-none'
              placeholder='Search'
              type="text" />
          </div>
        </div>
