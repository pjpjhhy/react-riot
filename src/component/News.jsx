  ...
  return (
    <>
      <div className='w-full flex justify-center bg-[#f8f9fa]'> 
        <div className='w-full max-w-7xl py-16 flex flex-col space-y-4'>
            {/* title */}
            ...
            <div className='w-full grid grid-cols-2 gap-x-[10px] gap-y-[50px] pl-8 '>
                <div 
                style={{clipPath: 'polygon(0 0, 100% 0, 100% 90%, 95% 100%, 0 100%, 0% 50%)'}}
                className='flex w-[500px] group h-[200px] space-x-3 border-[3px] bg-white border-slate-400 cursor-pointer'>
                    {/* img */}
                ...
                <div 
                style={{clipPath: 'polygon(0 0, 100% 0, 100% 90%, 95% 100%, 0 100%, 0% 50%)'}}
                className='flex w-[500px] h-[200px] group space-x-3 border-[3px] bg-white border-slate-400 cursor-pointer'>
                    {/* img */}
                    <div className='w-2/5 h-full overflow-hidden'>
                        <img 
                        className='w-full h-full group-hover:scale-105 duration-300'
                ...
                <div 
                style={{clipPath: 'polygon(0 0, 100% 0, 100% 90%, 95% 100%, 0 100%, 0% 50%)'}}
                className='flex w-[500px] h-[200px] space-x-3 border-[3px] group bg-white border-slate-400 cursor-pointer'>
                    {/* img */}
                    <div className='w-2/5 h-full overflow-hidden'>
                        <img 
                        className='w-full h-full group-hover:scale-105 duration-300'
