...
export default function Footer() {
  return (
    <div className='w-full h-full bg-[#111111] flex justify-center items-center'>
      <div className=' max-w-7xl w-full flex flex-col justify-center space-y-5 pt-2 pb-14'>
        {/* sns icons */}
        <div className='w-full flex justify-center text-white py-4 space-x-6 cursor-pointer'>
          <div className='h-11 w-11 rounded-xl flex justify-center items-center text-2xl bg-[#282828]'>
          <IoLogoYoutube />
          </div>
          <div className='h-11 w-11 rounded-xl flex justify-center items-center text-2xl bg-[#282828]'>
          <FaInstagram />
        ...
        <div className='flex justify-center items-center'>
          ...
          src="https://images.contentstack.io/v3/assets/blt0eb2a2986b796d29/blt347042469caad5ee/5e8639455bca9a639e7dd8c1/kr-rating.png?&height=100&disable=upscale" alt="" />
        </div>
      </div>
    </div>
  )
